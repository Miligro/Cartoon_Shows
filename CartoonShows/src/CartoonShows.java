...
class CartoonShows implements ActionListener
  {  
   JLabel displayLabel;
   JButton nextButton;
   JButton prevButton;
   ...
   ResourceBundle CartoonShowsResources;
   ...
   CartoonShows()
     {  
      try
        {
         CartoonShowsResources = ResourceBundle.getBundle("resources.CartoonShowsResources",Locale.getDefault());
        }
      ...
      JFrame jfrm = new JFrame(CartoonShowsResources.getString("CartoonShows"));  
      ...
      prevButton = new JButton(CartoonShowsResources.getString("Prev"));
      prevButton.setActionCommand("Prev");
      buttonPanel.add(prevButton);
      prevButton.addActionListener(this);
      
      nextButton = new JButton(CartoonShowsResources.getString("Next"));
   ...
   private void nextUIState() throws Exception
     {
      ...
      if (fv.getFactSlot("state").toString().equals("final"))
        { 
         ...
         nextButton.setText(CartoonShowsResources.getString("Restart")); 
         prevButton.setVisible(true);
        }
      else if (fv.getFactSlot("state").toString().equals("initial"))
        {
         nextButton.setActionCommand("Next");
         nextButton.setText(CartoonShowsResources.getString("Next"));
      ...
      for (int i = 0; i < pv.size(); i++) 
        {
         ...
         if (bv.toString().equals(selected))
            { rButton = new JRadioButton(CartoonShowsResources.getString(bv.toString()),true); }
         else
            { rButton = new JRadioButton(CartoonShowsResources.getString(bv.toString()),false); }
      ...
      String theText = CartoonShowsResources.getString(fv.getFactSlot("display").symbolValue());
   ...
   public static void main(String args[])
     {  
      SwingUtilities.invokeLater(
        new Runnable() 
          {  
           public void run() { new CartoonShows(); }  
          });   
     }  
  }